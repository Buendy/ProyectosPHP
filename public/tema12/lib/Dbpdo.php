...
class DBpdo
{
  ...
  private function connection()
  {
    ...
    $options = [PDO::ATTR_PERSISTENT => $this->modeDEV, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION];
...
public function insert($params)
{
  if(! empty($params)){
    ...
    throw new Exception('Los parametros están vacíos');
  }
}
...
public function delete($param)
{
  if(!empty($param)){
    ...
    throw new Exception('Los parámetros están vacíós');
  }
}
